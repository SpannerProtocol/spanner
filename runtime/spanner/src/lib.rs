...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("spanner"),
    impl_name: create_runtime_str!("spanner"),
    authoring_version: 1,
...
impl Filter<Call> for BaseFilter {
    fn filter(call: &Call) -> bool {
        // Avoid processing transactions from staking module.
        !matches!(
            call,
            Call::Staking(..)
                | Call::Recovery(..)
...
type EnsureRootOrHalfBulletTrainEngineer = EnsureOneOf<
    AccountId,
    EnsureRoot<AccountId>,
...
impl pallet_dex::Config for Runtime {
    ...
    type ListingOrigin = EnsureRootOrHalfBulletTrainEngineer;
}
...
parameter_types! {
    pub const BulletTrainEngineerMotionDuration: BlockNumber = 5 * DAYS;
    pub const BulletTrainEngineerMaxProposals: u32 = 100;
    pub const BulletTrainEngineerMaxMembers: u32 = 100;
}

type BulletTrainEngineerCollective = pallet_collective::Instance3;
impl pallet_collective::Config<BulletTrainEngineerCollective> for Runtime {
    type Origin = Origin;
    type Proposal = Call;
    type Event = Event;
    type MotionDuration = BulletTrainEngineerMotionDuration;
    type MaxProposals = BulletTrainEngineerMaxProposals;
    type MaxMembers = BulletTrainEngineerMaxMembers;
    type DefaultVote = pallet_collective::PrimeDefaultVote;
    type WeightInfo = pallet_collective::weights::SubstrateWeight<Runtime>;
}
...
parameter_types! {
    pub const MinimumYieldFarmingReward: Balance = 10_000_000_000;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        Voting: pallet_voting::{Origin<T>, Module, Call, Storage, Event<T>},
        Dex: pallet_dex::{Module, Call, Storage, Event<T>, Config<T>},
        Tokens: orml_tokens::{Module, Storage, Event<T>, Config<T>},
        Currencies: orml_currencies::{Module, Call, Event<T>},
        Rewards: pallet_rewards::{Module, Call, Storage, Event<T>},
        BulletTrainEngineer: pallet_collective::<Instance3>::{Module, Call, Storage, Origin<T>, Event<T>, Config<T>},
    }
);
